...
public class StateTransitionKeyListenerContainer
{
    ...
    public StateTransitionKeyListenerContainer(MainGameFrame frame, MainCharacterTurnHandler turnHandler, GameWorld gameWorld)
    {
        ...
        this.listeners.put(DispatchKeyListener.STATE_LOAD_SCREEN, new LoadScreenKeyListener(new LoadScreenRenderer(frame), gameWorld));
        ...
        this.listeners.put(DispatchKeyListener.STATE_HOTKEYS_SCREEN, new HotkeysScreenKeyListener(new HotkeysScreenRenderer(frame)));
    }
