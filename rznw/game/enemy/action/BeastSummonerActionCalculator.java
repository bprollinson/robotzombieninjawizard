...
public class BeastSummonerActionCalculator extends EnemyActionCalculator
{
    ...
    private EnemySpellAction getSpellAction(GameWorld gameWorld, EnemyCharacter enemyCharacter)
    {
        ...
        if (Math.abs(mainCharacterMapElement.getRow() - enemyMapElement.getRow()) > BeastSummonerActionCalculator.RADIUS || Math.abs(mainCharacterMapElement.getColumn() - enemyMapElement.getColumn()) > BeastSummonerActionCalculator.RADIUS)
        {
            return null;
        }
